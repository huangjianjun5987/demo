 ...
 * @版本: v1.0
 */
public class ReturnRequestQueryParamDto extends BaseDto implements Serializable {

	private static final long	serialVersionUID	= -7620196919603029359L;
	...
	private String				franchiseeId;								// 小超//编码和小超名称
