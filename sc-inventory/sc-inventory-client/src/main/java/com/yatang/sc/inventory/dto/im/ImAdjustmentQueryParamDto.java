...
import com.yatang.sc.inventory.dto.BaseDto;
...
public class ImAdjustmentQueryParamDto extends BaseDto implements Serializable {
	...
	public String toString() {
		return "ImAdjustmentQueryParamDto{" +
				"id=" + id +
				", status=" + status +
