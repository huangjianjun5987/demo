 ...
 * @版本: v1.0
 */
public class ItemLocSohDto implements Serializable {
    private static final long serialVersionUID = -3296277523266369447L;
    private Long id; //pk
    ...
    public void setStockOnHand(Long stockOnHand) {
        this.stockOnHand = stockOnHand==null ? 0:stockOnHand;
    }
    ...
    public void setInTransitQty(Long inTransitQty) {
        this.inTransitQty = inTransitQty==null ? 0:inTransitQty;
    }
    ...
    public void setOrderReservedQty(Long orderReservedQty) {
        this.orderReservedQty = orderReservedQty==null ? 0:orderReservedQty;
    }
    ...
    public void setTsfReservedQty(Long tsfReservedQty) {
        this.tsfReservedQty = tsfReservedQty==null ? 0:tsfReservedQty;
    }
    ...
    public void setSellInTransitQty(Long sellInTransitQty) {
        this.sellInTransitQty = sellInTransitQty==null ? 0:sellInTransitQty;
    }
    ...
    public void setTsfExpectedQty(Long tsfExpectedQty) {
        this.tsfExpectedQty = tsfExpectedQty==null ? 0:tsfExpectedQty;
    }
    ...
    public void setRtvQty(Long rtvQty) {
        this.rtvQty = rtvQty==null ? 0:rtvQty;
    }
