...
public class ImAdjustmentQueryListPo implements Serializable {

	private static final long			serialVersionUID	= -3366694915990147265L;
	private Long						id;											// pk
	...
	private List<ImAdjustmentItemPo>	imAdjustmentItemVos;						// 库存调整单商品集合
	...
	public void setImAdjustmentItemVos(List<ImAdjustmentItemPo> imAdjustmentItemVos) {
	...
	public List<ImAdjustmentItemPo> getImAdjustmentItemVos() {
