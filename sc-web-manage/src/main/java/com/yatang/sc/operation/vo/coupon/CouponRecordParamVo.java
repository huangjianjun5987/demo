...
/**
 * @description: 优惠券使用情况查询参数vo
 * @author: yinyuxin
 * @date: 2017/9/21 10:16
 * @version: v1.0
 */
public class CouponRecordParamVo extends BaseVo implements Serializable {

	private static final long serialVersionUID = -6498337188516430477L;
