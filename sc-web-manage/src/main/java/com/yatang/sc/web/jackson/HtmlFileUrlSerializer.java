package com.yatang.sc.web.jackson;
 ...
 */
public class HtmlFileUrlSerializer extends JsonSerializer<Object> {
	...
	private void serializeContent(String text, JsonGenerator gen, SerializerProvider provider) throws IOException {
		...
		String imageDomain = String.valueOf(provider.getAttribute("fileViewDomain"));
