...
public class ResultEventListenerMethodProcessor implements SmartInitializingSingleton, ApplicationContextAware {
    ...
    protected List<EventListenerFactory> getEventListenerFactories() {
        List<EventListenerFactory> allFactories = new ArrayList<>();
        allFactories.add(this.applicationContext.getBean(ResultEventListenerFactory.class));
                ...
                for (Method method : annotatedMethods.keySet()) {
                    for (EventListenerFactory factory : factories) {
                        if (factory.supportsMethod(method)) {
                            ...
                            if (applicationListener instanceof ApplicationListenerResultMethodAdapter) {
                                ((ApplicationListenerResultMethodAdapter) applicationListener).init(this.applicationContext, this.evaluator);
                            }
                            this.resultApplicationEventMulticaster.addApplicationListener(applicationListener);
                            break;
                        }
                    }
                }
