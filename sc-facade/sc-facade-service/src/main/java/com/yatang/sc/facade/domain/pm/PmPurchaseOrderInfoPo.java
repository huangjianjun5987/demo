...
@Setter
@Getter
public class PmPurchaseOrderInfoPo implements Serializable {
	private static final long			serialVersionUID	= 3134837990589909614L;
	private Long						id;											// pk
	...
	// new
	private List<PmPurchaseOrderItemPo>	pmPurchaseOrderItems;						// 采购单商品表po类
