...
public class PmPurchaseRefundPo implements Serializable {
	/**
	 * 
	 */
	private Long							id;
	...
	private List<PmPurchaseRefundItemPo>	pmPurchaseRefundItems;
	...
	public List<PmPurchaseRefundItemPo> getPmPurchaseRefundItems() {
		return pmPurchaseRefundItems;
	}



	public void setPmPurchaseRefundItems(List<PmPurchaseRefundItemPo> pmPurchaseRefundItems) {
