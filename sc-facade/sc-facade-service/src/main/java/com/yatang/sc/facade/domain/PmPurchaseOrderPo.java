...
@Setter
@ToString
public class PmPurchaseOrderPo implements Serializable {
	private static final long serialVersionUID = 5936093050248167364L;
	...
	private BigDecimal totalTaxAmount;//总税额 new

	private BigDecimal totalWithoutTaxAmount;//不含税采购金额 new

	private BigDecimal totalAmount;//总采购金额，含税 new
