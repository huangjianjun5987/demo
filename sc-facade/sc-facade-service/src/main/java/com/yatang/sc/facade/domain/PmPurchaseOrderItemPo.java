...
@Setter
@ToString
public class PmPurchaseOrderItemPo implements Serializable {
    private static final long serialVersionUID = -4831625287061316226L;

    private Long id;

    private String purchaseOrderId;//采购id
    ...
    private BigDecimal totalAmount;//采购金额，含税 new
