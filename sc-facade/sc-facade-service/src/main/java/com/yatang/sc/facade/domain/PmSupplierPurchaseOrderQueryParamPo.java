...
/**
 * @描述: 供应商采购单列表查询条件PO类
 * @类名: PmSupplierPurchaseOrderQueryParamPo
 * @作者: kangdong
 * @创建时间: 2018/1/9 17:11
 * @版本: v1.0
 */
@Getter
@Setter
public class PmSupplierPurchaseOrderQueryParamPo extends BasePo implements Serializable {


	private static final long serialVersionUID = 4050003291646107872L;
	...
	private Integer				sort;										// 排序:1按预计收货日期升序;2按预计收货日期降序;3按订单号升序;4按订单号降序
