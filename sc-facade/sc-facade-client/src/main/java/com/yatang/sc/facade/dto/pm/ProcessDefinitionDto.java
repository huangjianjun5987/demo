...
public class ProcessDefinitionDto implements Serializable {
	 ...
	 * 当前节点审批日志
	 */
	private ProcessAuditLogDto processAuditLog;
	...
	public ProcessAuditLogDto getProcessAuditLog() {
		return processAuditLog;
	}



	public void setProcessAuditLog(ProcessAuditLogDto processAuditLog) {
