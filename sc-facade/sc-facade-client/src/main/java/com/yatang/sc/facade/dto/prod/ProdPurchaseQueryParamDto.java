...
@Getter
@Setter
public class ProdPurchaseQueryParamDto extends BaseDto implements Serializable {

    private static final long serialVersionUID = -9156689317660619681L;
    private String spId;//供应商id
    private String spAdrId;//供应商地点id
    private String branchCompanyId;//子公1司code(平台)
