 ...
 */
public class kiddPurchaseRefundConfirmResultResultDto implements Serializable {
	...
	private kiddPurchaseRefundConfirmPackagesDto			packages;					// 包裹没有编码时packages不用传值
	private String											remark;						//
	private List<kiddPurchaseRefundConfirmOrderLinesDto>	orderLines;					// 否货品信息，无货品相关信息时不传值。具体数据结构见下表。
	...
	public kiddPurchaseRefundConfirmPackagesDto getPackages() {
		return packages;
	}



	public void setPackages(kiddPurchaseRefundConfirmPackagesDto packages) {
	...
	public List<kiddPurchaseRefundConfirmOrderLinesDto> getOrderLines() {
		return orderLines;
	}



	public void setOrderLines(List<kiddPurchaseRefundConfirmOrderLinesDto> orderLines) {
