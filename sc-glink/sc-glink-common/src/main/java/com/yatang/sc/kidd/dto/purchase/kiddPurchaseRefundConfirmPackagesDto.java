 ...
 */
public class kiddPurchaseRefundConfirmPackagesDto implements Serializable {
	...
	private kiddPurchaseRefundConfirmPackagesItemsDto	items;						// 该包裹内的商品信息
	...
	public kiddPurchaseRefundConfirmPackagesItemsDto getItems() {
		return items;
	}



	public void setItems(kiddPurchaseRefundConfirmPackagesItemsDto items) {
		this.items = items;
	}
