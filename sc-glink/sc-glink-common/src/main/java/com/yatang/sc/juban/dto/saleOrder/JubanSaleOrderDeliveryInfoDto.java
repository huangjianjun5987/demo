...
public class JubanSaleOrderDeliveryInfoDto implements Serializable {
    ...
    private JubanSaleOrderReceiverInfoDto receiverInfo;//收货人信息

    private List<JubanSaleOrderRelateOrderDto> relatedOrders;
    /**
     * 发货单
     */
    ...
    public JubanSaleOrderReceiverInfoDto getReceiverInfo() {
        return receiverInfo;
    }

    public void setReceiverInfo(JubanSaleOrderReceiverInfoDto receiverInfo) {
        this.receiverInfo = receiverInfo;
    }

    public List<JubanSaleOrderRelateOrderDto> getRelatedOrders() {
        return relatedOrders;
    }

    public void setRelatedOrders(List<JubanSaleOrderRelateOrderDto> relatedOrders) {
